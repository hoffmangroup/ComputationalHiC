...
function areaNew(xxx_axis_array, yyy_axis_array)

	local area = 0.0 

	for i=1,#xxx_axis_array do
	    if i>=2 then
		area = area + (xxx_axis_array[i] - xxx_axis_array[i-1])*((yyy_axis_array[i]+yyy_axis_array[i-1])/2.0)
	    end
	end
